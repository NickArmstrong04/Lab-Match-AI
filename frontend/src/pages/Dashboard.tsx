                ...
                <div className="flex-1 min-h-0 overflow-y-auto overscroll-y-contain pr-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 rounded-lg bg-stone-50 border border-stone-200 mb-6 text-sm">
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-1">
                      ...
                      {currentMatch.pi_contact ? (
                        <div className="space-y-0.5">
                          <div className="text-stone-800 font-mono text-xs break-all">
                            {currentMatch.pi_contact.email}
                          </div>
                          {currentMatch.pi_contact.source_url ? (
                            <a
                              href={currentMatch.pi_contact.source_url}
                              target="_blank"
                              rel="noopener noreferrer"
                              onMouseDown={(e) => e.stopPropagation()}
                              className="text-[#0d5c5c] text-[10px] flex items-center gap-1 hover:underline"
                            >
                              {piContactSourceLabel(currentMatch.pi_contact)}
